...
{
    // Crear un nuevo nodo con el jugador y la fecha
...
{
    TFecha fechaMayor = NULL; // Inicializamos con NULL
    rep_nodo *actual = jugadores->inicio;
...
{
    TJugadoresLDE jugadoresConFecha = crearTJugadoresLDE(); // Crear una nueva lista vacía para los jugadores con la fecha dada
    rep_nodo *actual = jugadores->inicio;
    ...
    while (actual != NULL)
    {
        ...
        {
            // Si la fecha del jugador coincide con la fecha proporcionada, copiamos el jugador a la nueva lista
